...
class BitcoinServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // $this->loadViewsFrom(__DIR__.'/../resources/views', 'bitcoin');
        ...
        if ($this->app->runningInConsole()) {
            ...
            /*$this->publishes([
                __DIR__.'/../resources/views' => resource_path('views/vendor/bitcoin'),
            ], 'views');*/

            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/bitcoin'),
            ], 'assets');*/

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/bitcoin'),
            ], 'lang');*/
